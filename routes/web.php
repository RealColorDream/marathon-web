...
Route::get('/voyages/{id}/etapes/create', [EtapeController::class, 'create'])->name('etapes.create');
Route::post('/voyages/{id}/etapes', [EtapeController::class, 'store'])->name('etapes.store');
